...
### Project Goals
In this project, our team focused on leveraging these advanced encryption techniques to develop a model that predicts ... .The goal was to ensure that the predictions are made securely without compromising ... .
...
2. **Model Development**: Created a machine learning model using Concrete ML to ... .
